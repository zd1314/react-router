...
class ReactEllipseForceDirectedTagCloud extends Component {
  constructor(props) {
    ...
    this.totalLen = timeData.length - 2;
    this.timer = null;
    this.liStyle = {
      cursor: 'pointer',
      borderRadius: '5px',
        ...
        <div style={{
          ...
          <ul ref={'tooltipRef'} className={'foce-tooltip-xf'} style={{
            ...
            <li style={{
              ...
              <p ref={'colorList'} style={{margin: 0, width: 18, height: 18, backgroundColor: '#fd8f35', borderRadius: '50%', marginRight: 10}}></p>
  ...
  showTooltip(options, isShow) {
    ...
    ref.colorList.style.backgroundColor = options.category ? 'rgba(43, 212, 197)' : '#fd8f35';
